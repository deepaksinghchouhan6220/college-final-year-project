                ...
                <div className="inside_container mx-auto">
                    <div className="row">
                        <div className="col-md-3 d-flex align-items-center">
                            <h1 className="logo">Apna Samaan</h1>
                        </div>
                        <div className="col-md-6">
                            <div className="search_container mx-auto">
                                <div className="search_container mx-auto">
                                    <div className="input-group mt-3">
                                        <input type="search" className="form-control rounded input_area" placeholder="Search"  />
                        ...
                        <div className="col-md-3">
                            <div className="container mt-3  d-flex justify-content-around">
                                <div><BiHeart className="icons"/></div>
                                <div><FaShoppingCart className="icons"/></div>
